	...
	m_ui(new Ui::QuadPreview)
{
	...
	m_devicePages[4] = m_ui->devicePage5;
	m_devicePages[5] = m_ui->devicePage6;
	m_devicePages[6] = m_ui->devicePage7;
	m_devicePages[7] = m_ui->devicePage8;

	m_devicePages[8] = m_ui->devicePage9;
	m_devicePages[9] = m_ui->devicePage10;
	m_devicePages[10] = m_ui->devicePage11;
	m_devicePages[11] = m_ui->devicePage12;
	m_devicePages[12] = m_ui->devicePage13;
	m_devicePages[13] = m_ui->devicePage14;
	m_devicePages[14] = m_ui->devicePage15;
	m_devicePages[15] = m_ui->devicePage16;
	...
	for (size_t i = 0; i < m_devicePages.size(); i++)
	{
		...
		m_previewLayout->addWidget(m_devicePages[i]->getPreviewView(), /* row */ (int)i / 4, /* column */ (int)i % 4);
